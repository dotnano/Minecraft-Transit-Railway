...
public enum RailType implements IGui {
	...
	BEDROCK_400(400, MaterialColor.CYAN_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_500(500, MaterialColor.CYAN_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_600(600, MaterialColor.CYAN_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_700(700, MaterialColor.CYAN_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_800(800, MaterialColor.CYAN_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_900(900, MaterialColor.CYAN_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
	BARRIER(1000, MaterialColor.RED_TERRACOTTA, false, true, true, RailSlopeStyle.CURVE),
