...
public enum RailType implements IGui {
	...
	NETHERITE(350, MaterialColor.NETHER, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_400(400, MaterialColor.TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_500(500, MaterialColor.TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_600(600, MaterialColor.TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_700(700, MaterialColor.TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_800(800, MaterialColor.TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
	BEDROCK_900(900, MaterialColor.TERRACOTTA_CYAN, false, true, true, RailSlopeStyle.CURVE),
	BARRIER(1000, MaterialColor.TERRACOTTA_RED, false, true, true, RailSlopeStyle.CURVE),
