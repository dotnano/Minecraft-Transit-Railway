...
public interface Items {
	...
	RegistryObject<Item> RAIL_CONNECTOR_350 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.NETHERITE));
	RegistryObject<Item> RAIL_CONNECTOR_350_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.NETHERITE));
	RegistryObject<Item> RAIL_CONNECTOR_400 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BEDROCK_400));
	RegistryObject<Item> RAIL_CONNECTOR_400_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BEDROCK_400));
	RegistryObject<Item> RAIL_CONNECTOR_500 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BEDROCK_500));
	RegistryObject<Item> RAIL_CONNECTOR_500_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BEDROCK_500));
	RegistryObject<Item> RAIL_CONNECTOR_600 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BEDROCK_600));
	RegistryObject<Item> RAIL_CONNECTOR_600_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BEDROCK_600));
	RegistryObject<Item> RAIL_CONNECTOR_700 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BEDROCK_700));
	RegistryObject<Item> RAIL_CONNECTOR_700_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BEDROCK_700));
	RegistryObject<Item> RAIL_CONNECTOR_800 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BEDROCK_800));
	RegistryObject<Item> RAIL_CONNECTOR_800_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BEDROCK_800));
	RegistryObject<Item> RAIL_CONNECTOR_900 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BEDROCK_900));
	RegistryObject<Item> RAIL_CONNECTOR_900_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BEDROCK_900));
	RegistryObject<Item> RAIL_CONNECTOR_1000 = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, false, RailType.BARRIER));
	RegistryObject<Item> RAIL_CONNECTOR_1000_ONE_WAY = new RegistryObject<>(() -> new ItemRailModifier(true, false, true, true, RailType.BARRIER));
