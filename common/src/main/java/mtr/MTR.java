...
public class MTR implements IPacket {
	...
	public static void init(
		...
		if (!Keys.LIFTS_ONLY) {
			...
			registerItem.accept("rail_connector_350", Items.RAIL_CONNECTOR_350);
			registerItem.accept("rail_connector_350_one_way", Items.RAIL_CONNECTOR_350_ONE_WAY);
			registerItem.accept("rail_connector_400", Items.RAIL_CONNECTOR_400);
			registerItem.accept("rail_connector_400_one_way", Items.RAIL_CONNECTOR_400_ONE_WAY);
			...
			registerItem.accept("rail_connector_900", Items.RAIL_CONNECTOR_900);
			registerItem.accept("rail_connector_900_one_way", Items.RAIL_CONNECTOR_900_ONE_WAY);
			registerItem.accept("rail_connector_1000", Items.RAIL_CONNECTOR_1000);
			registerItem.accept("rail_connector_1000_one_way", Items.RAIL_CONNECTOR_1000_ONE_WAY);
